...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Identities alert', detail: 'Identities queue needs review.', read: false },
  { id: 'note-2', title: 'Applications approval due', detail: 'Applications exception list needs approval.', read: false },
  { id: 'note-3', title: 'Entitlements updated', detail: 'Entitlements operating queue was refreshed.', read: true },
];

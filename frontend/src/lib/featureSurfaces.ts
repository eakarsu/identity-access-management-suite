...
const featureSeeds = [
  ['identities', 'Identities', 'Identities operating queue', 'Security Lead', 'Review and assign next action'],
  ['applications', 'Applications', 'Applications operating queue', 'Security Lead', 'Review and assign next action'],
  ['entitlements', 'Entitlements', 'Entitlements operating queue', 'Security Lead', 'Review and assign next action'],
  ['access-requests', 'Access Requests', 'Access Requests operating queue', 'Security Lead', 'Review and assign next action'],
  ['reviews', 'Reviews', 'Reviews operating queue', 'Operations Lead', 'Review and assign next action'],
  ['policies', 'Policies', 'Policies operating queue', 'Operations Lead', 'Review and assign next action'],
  ['privileged-access', 'Privileged Access', 'Privileged Access operating queue', 'Operations Lead', 'Review and assign next action'],
  ['lifecycle', 'Lifecycle', 'Lifecycle operating queue', 'Operations Lead', 'Review and assign next action'],
  ['violations', 'Violations', 'Violations operating queue', 'Governance Lead', 'Review and assign next action'],
  ['approvals', 'Approvals', 'Approvals operating queue', 'Governance Lead', 'Review and assign next action'],

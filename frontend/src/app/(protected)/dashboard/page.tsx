...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Identity Access Management Dashboard"
      subtitle="One merged identity access management view for Identities, Applications, Entitlements, Access Requests, Reviews, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared identity access management jobs into one surface. Identities, Applications, Entitlements, Access Requests, Reviews, Policies, documents, audit, and AI are presented as platform features.</div>

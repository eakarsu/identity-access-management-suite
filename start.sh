...
PORT="${PORT:-4710}"
DB_NAME="${PGDATABASE:-identity_access_management_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Identity Access Management Suite"
echo "======================================="
echo
...
echo "Starting identity access management suite frontend on http://localhost:$PORT"
echo "Login: admin@identity-access.local / admin123"
